...
#include "./sourcefiles/crypto/FourQlib/FourQ_64bit_and_portable/FourQ_api.h"
#include "./sourcefiles/crypto/FourQlib/FourQ_64bit_and_portable/FourQ_params.h"
#include "./sourcefiles/crypto/FourQlib/random/random.h"
#include "./sourcefiles/crypto/FourQlib/sha512/sha512.h"
#include "./sourcefiles/crypto/FourQlib/FourQ_64bit_and_portable/tests/test_extras.h"
#include <stdio.h>
...
{ // Benchmark the SchnorrQ digital signature scheme
    ...
    printf("  SchnorrQ's key generation runs in ............................................... %8lld ", cycles / BENCH_LOOPS);
    print_unit;
    printf("\n");
    ...
    printf("  SchnorrQ's signing runs in ...................................................... %8lld ", cycles / BENCH_LOOPS);
    print_unit;
    printf("\n");
    ...
    printf("  SchnorrQ's verification runs in ................................................. %8lld ", cycles / BENCH_LOOPS);
    print_unit;
    printf("\n");
...
{ // Test ECDH key exchange based on FourQ
    ...
    if (passed == 1)
        printf("  DH key exchange tests............................................................ PASSED");
    else
    {
        printf("  DH key exchange tests... FAILED");
        printf("\n");
...
{ // Benchmark ECDH key exchange based on FourQ
    ...
    printf("  Keypair generation runs in ...................................................... %8lld ", cycles / BENCH_LOOPS);
    print_unit;
    printf("\n");
    ...
    printf("  Secret agreement runs in ........................................................ %8lld ", cycles / BENCH_LOOPS);
    print_unit;
    printf("\n");
...
{ // Test hashing to FourQ
    ...
    for (n = 0; n < TEST_LOOPS; n++)
    {
        ...
        if (fp2compare64((uint64_t *)P->x, (uint64_t *)Q->x) != 0 || fp2compare64((uint64_t *)P->y, (uint64_t *)Q->y) != 0)
        {
            passed = 0;
            break;
        }
    ...
    if (passed == 1)
        printf("  Hash to FourQ tests.............................................................. PASSED");
    else
    {
        printf("  Hash to FourQ tests... FAILED");
        printf("\n");
...
{ // Benchmark hashing to FourQ
    ...
    printf("  Hashing to FourQ runs in ....................................................... %8lld ", cycles / BENCH_LOOPS);
    print_unit;
    printf("\n");
