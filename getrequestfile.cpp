...
int main(void)
{
	...
	scrsa rsa;
	//std::string str = rsa.bignumToString(rsa.stringToBignum(hardwareInfoStr));
	std::cout << "plain 1:\n" << hexToString(hardwareInfoStr) << std::endl;
	std::string binEncryptostr = rsa.encrypt_string(rsaPubKeyStr1, rsaN1, hardwareInfoStr);
	//std::string str = rsa.decrypt_string(rsaPrivateKeyStr1, rsaN1, binEncryptostr);
	//std::cout << "2:" << str << std::endl;

	std::ofstream outfile("./hwinfo.txt");
